...
figure(1)
scatter3(HIGH(:,1),HIGH(:,2),HIGH(:,3),'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75])
hold on
scatter3(LOW(:,1),LOW(:,2),LOW(:,3),'MarkerEdgeColor','k','MarkerFaceColor',[1 .75 .75])
title('former distribution.');
